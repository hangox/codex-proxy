export const translations = {
  en: {
    ...
    generalSettingsCompactBridgeHint: "Convert classic Claude Code compaction into Codex compact + render. Applies immediately; disabled by default.",
        generalSettingsOpaqueCompact: "Experimental Opaque Compact State",
        generalSettingsOpaqueCompactHint: "Compact once, keep opaque state in memory, and return a short signed marker. Takes priority over the classic bridge; state is lost on restart.",
  ...
  zh: {
    ...
    generalSettingsCompactBridgeHint: "将经典 Claude Code 压缩请求转换为 Codex compact + render。立即生效，默认关闭。",
        generalSettingsOpaqueCompact: "实验性 Opaque 压缩状态",
        generalSettingsOpaqueCompactHint: "只执行一次 compact，将 opaque 状态保存在内存并返回短签名 marker。优先于经典桥接；重启后状态失效。",
