export const translations = {
  en: {
    ...
    generalSettingsOpaqueCompactBudgets: "Opaque Compact Budgets",
    generalSettingsOpaqueCompactBudgetsHint: "Per-model preflight budgets for native opaque compact. Leave a row blank to use its calibrated automatic budget. Changes are hot-reloaded without restarting the container.",
    generalSettingsOpaqueCompactModel: "Model",
    generalSettingsOpaqueCompactOverride: "Override",
    generalSettingsOpaqueCompactEffective: "Effective",
    generalSettingsOpaqueCompactRecommended: "Recommended",
    generalSettingsOpaqueCompactVerifiedSuccess: "Verified success",
    generalSettingsOpaqueCompactFirstFailure: "First failure",
    generalSettingsOpaqueCompactStatus: "Status",
    generalSettingsOpaqueCompactAutomatic: "Automatic",
    generalSettingsOpaqueCompactOverridden: "Override active",
    generalSettingsOpaqueCompactWarning: "Above recommendation; still below the first verified failure boundary.",
    generalSettingsOpaqueCompactExperimental: "Experimental model",
    generalSettingsOpaqueCompactReset: "Reset",
    generalSettingsOpaqueCompactAddModel: "Add custom model",
    generalSettingsOpaqueCompactModelPlaceholder: "Model ID",
    generalSettingsOpaqueCompactBudgetPlaceholder: "Tokens",
    generalSettingsOpaqueCompactAdd: "Add",
    generalSettingsOpaqueCompactNoBoundary: "Not measured",
    generalSettingsOpaqueCompactTokens: "tokens",
    generalSettingsOpaqueCompactValidation: "Enter an integer from 1 to 1,000,000.",
    generalSettingsOpaqueCompactBoundaryValidation: "This value must be lower than the first verified failure boundary ({tokens}).",
    generalSettingsOpaqueCompactCustomModelValidation: "Enter a custom model ID before adding it.",
    generalSettingsOpaqueCompactAllowedModelsHint: "Only currently routable Codex models can be added. Register a custom model under model.custom_models or add an alias to a catalog model first.",
    generalSettingsOpaqueCompactModelNotRoutable: "This model is not routable yet. Register it under model.custom_models or add an alias to a catalog model first.",
    ...
    generalSettingsImageHostModelHint: "The actual Codex chat model that image_generation tool calls are routed to. Client Images requests still send model \"gpt-image-2\" — that is only a client-side identifier, never used as the host model.",
    generalSettingsImageHostModelNotAllowed: "This model is not an available Images host model. Register it under model.custom_models or add an alias to a catalog model first.",
  ...
  zh: {
    ...
    generalSettingsOpaqueCompactBudgets: "Opaque Compact 预算",
    generalSettingsOpaqueCompactBudgetsHint: "按模型设置 Opaque Compact 预检预算。留空表示使用已校准的自动预算；保存后热加载，无需重启容器。",
    generalSettingsOpaqueCompactModel: "模型",
    generalSettingsOpaqueCompactOverride: "覆盖值",
    generalSettingsOpaqueCompactEffective: "当前生效",
    generalSettingsOpaqueCompactRecommended: "推荐值",
    generalSettingsOpaqueCompactVerifiedSuccess: "已验证成功",
    generalSettingsOpaqueCompactFirstFailure: "首次失败",
    generalSettingsOpaqueCompactStatus: "状态",
    generalSettingsOpaqueCompactAutomatic: "自动",
    generalSettingsOpaqueCompactOverridden: "已覆盖",
    generalSettingsOpaqueCompactWarning: "高于推荐值，但仍低于首次实测失败边界。",
    generalSettingsOpaqueCompactExperimental: "实验模型",
    generalSettingsOpaqueCompactReset: "重置",
    generalSettingsOpaqueCompactAddModel: "添加自定义模型",
    generalSettingsOpaqueCompactModelPlaceholder: "模型 ID",
    generalSettingsOpaqueCompactBudgetPlaceholder: "Token 数",
    generalSettingsOpaqueCompactAdd: "添加",
    generalSettingsOpaqueCompactNoBoundary: "未测量",
    generalSettingsOpaqueCompactTokens: "tokens",
    generalSettingsOpaqueCompactValidation: "请输入 1 到 1,000,000 的整数。",
    generalSettingsOpaqueCompactBoundaryValidation: "该值必须低于首次实测失败边界（{tokens}）。",
    generalSettingsOpaqueCompactCustomModelValidation: "请先输入自定义模型 ID。",
    generalSettingsOpaqueCompactAllowedModelsHint: "这里只能添加当前可由 Codex 路由的模型。自定义模型请先注册到 model.custom_models，或先添加指向模型目录的 alias。",
    generalSettingsOpaqueCompactModelNotRoutable: "该模型当前不可路由。请先注册到 model.custom_models，或先添加指向模型目录模型的 alias。",
    ...
    generalSettingsImageHostModelHint: "image_generation 工具调用实际转发的 Codex 聊天宿主模型。客户端 Images 请求仍会发送 model \"gpt-image-2\"——那只是客户端标识，永远不会作为宿主模型使用。",
    generalSettingsImageHostModelNotAllowed: "该模型不是可用的 Images 宿主模型。请先注册到 model.custom_models，或先添加指向模型目录模型的 alias。",
