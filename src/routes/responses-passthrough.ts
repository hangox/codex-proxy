...
export const PASSTHROUGH_FORMAT: FormatAdapter = {
  ...
  streamTranslator: ({ api, response, model, onUsage, onResponseId, onResponseCompleted, tupleSchema, streamContext, onResponseMetadata }) => {
    if (!(response instanceof Response)) {
      throw new Error("Responses passthrough stream translator requires a Response");
    }
    return streamPassthrough(api, response, model, onUsage, onResponseId, tupleSchema, streamContext, onResponseCompleted, onResponseMetadata);
  },
