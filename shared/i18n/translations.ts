export const translations = {
  en: {
    ...
    compactViewBySession: "By session",
    compactViewByRequest: "By request",
    ...
    compactSessionHint:
      "Session-based counts may count the same session twice across a process restart boundary.",
