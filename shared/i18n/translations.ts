export const translations = {
  en: {
    ...
    generalSettingsOpaqueCompact: "Opaque Compact State",
    generalSettingsOpaqueCompactHint: "Compact once, persist the opaque state encrypted on disk, and return a short signed marker that still resolves after a process or container restart. Requires opaque_compact_state.keyring_file; disabled by default.",
  ...
  zh: {
    ...
    generalSettingsOpaqueCompact: "Opaque 压缩状态",
    generalSettingsOpaqueCompactHint: "只执行一次 compact，opaque 状态加密落盘，返回的短签名 marker 在进程或容器重启后仍能恢复。需配置 opaque_compact_state.keyring_file，默认关闭。",
